...
from random import seed, sample, randint, shuffle, randrange
...
def minigame():
    ...
    polygon = polygon_creator(sides = 3, x = -400, y = 0, radius = 70, rotation = 0)
    ...
    polygon = polygon_creator(sides = 5, x = 400, y = 0, radius = 70, rotation = 0)
