...
"""
Clasification of words and no-words.
Python 3.6.9
"""
...
with open('media/words.csv', encoding='utf8') as csvfile:
...
slides = {
    ...
    'welcome2': [
        ...
        "Después que la palabra desaparezca, tendrás que pensar en palabras relacionadas con la palabra que acabas de ver.",
    ...
    'wait': [
        ...
        "Piense en palabras relacionadas a la que acaba de ver."
        ],
    'spell': [
        "En voz alta, diga todas las palabras que acaba de pensar.",
        " ",
        " ",
        "Cuando termine de mencionar las palabras, presione la tecla Enter para continuar."
    ],
    'farewell': [
...
def show_word(word, subj_name, dfile, block_number):
    ...
    r_time = slide(slides['spell'], False, K_RETURN)
...
def main():
    ...
    subj_name = input("Escriba un nombre de archivo y presione ENTER para iniciar: ")
